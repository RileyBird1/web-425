...
describe('AuthService', () => {
  ...
  it('should set cookie and authState to true on successful signin', () => { const result = service.signin('galactic.smuggler@starwars.com', 'MayTheForce99');
  ...
  it('should not set cookie and authState to true on unsuccessful signin', () => {
    const result = service.signin('wrongemail@starwars.com', 'wrongpassword');
